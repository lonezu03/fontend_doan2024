...
import PosterImg from "../assets/Poster/poster1.jpg"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 
                    ...
                    <div className="flex flex-col justify-center gap-6 sm:pt-0">
                        ...
                        <p
                            ...
                            Combining timeless simplicity with contemporary elegance,
                            the shape system has been studied in greater depth to always keep up with the flow of the times.
                        </p>
                        <div className="flex flex-col gap-4">
                            ...
                            >
                                <GrSecure
                                    className="text-4xl h-12 w-12 shadow-sm p-4 rounde-full bg-violet-100 
                                     dark:bg-violet-400"
                                />
